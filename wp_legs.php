...
<html>
	...
	<body>
		...
		<?php
			...
			$sql="SELECT Exercise,Reps,Sets,Difficulty FROM workouts WHERE Muscle='Legs' and Difficulty<= ".$udiff.";";
		...
		<div id=seldif>				
			...
			<p><b>Tip(s):</b><ul><li>Rest for around 50-70seconds after each set.</li><li>Drink sufficient water</li></ul>
		</div>
